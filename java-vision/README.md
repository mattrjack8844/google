...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-vision" % "3.46.0"
```
...
Cloud Vision uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-vision/3.44.0
