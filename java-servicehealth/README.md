# Google Service Health API Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-servicehealth:0.15.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-servicehealth" % "0.15.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-servicehealth/0.13.0
