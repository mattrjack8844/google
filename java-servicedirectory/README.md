...
```Groovy
implementation 'com.google.cloud:google-cloud-servicedirectory:2.49.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-servicedirectory" % "2.49.0"
```
...
Service Directory uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-servicedirectory/2.47.0
