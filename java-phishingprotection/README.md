...
```Groovy
implementation 'com.google.cloud:google-cloud-phishingprotection:0.79.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-phishingprotection" % "0.79.0"
```
...
Phishing Protection uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-phishingprotection/0.77.0
