...
```Groovy
implementation 'com.google.cloud:google-cloud-recommendations-ai:0.55.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-recommendations-ai" % "0.55.0"
```
...
Recommendations AI uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-recommendations-ai/0.53.0
