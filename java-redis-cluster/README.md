# Google Google Cloud Memorystore for Redis API Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-redis-cluster:0.20.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-redis-cluster" % "0.20.0"
```
...
Google Cloud Memorystore for Redis API uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-redis-cluster/0.18.0
