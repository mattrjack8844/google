...
```Groovy
implementation 'com.google.analytics:google-analytics-data:0.59.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.analytics" % "google-analytics-data" % "0.59.0"
```
...
Analytics Data uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.analytics/google-analytics-data/0.57.0
