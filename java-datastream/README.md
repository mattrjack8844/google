...
```Groovy
implementation 'com.google.cloud:google-cloud-datastream:1.47.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datastream" % "1.47.0"
```
...
Datastream uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-datastream/1.45.0
