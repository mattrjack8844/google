...
```Groovy
implementation 'com.google.cloud:google-cloud-dialogflow:4.54.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dialogflow" % "4.54.0"
```
...
Dialogflow API uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dialogflow/4.52.0
