...
```Groovy
implementation 'com.google.shopping:google-shopping-merchant-reports:0.24.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.shopping" % "google-shopping-merchant-reports" % "0.24.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.shopping/google-shopping-merchant-reports/0.22.0
