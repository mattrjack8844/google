# Google Secure Source Manager API Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-securesourcemanager:0.18.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-securesourcemanager" % "0.18.0"
```
...
Secure Source Manager API uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-securesourcemanager/0.16.0
