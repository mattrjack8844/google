# Google Distributed Cloud Edge Network API Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-edgenetwork:0.16.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-edgenetwork" % "0.16.0"
```
...
Distributed Cloud Edge Network API uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-edgenetwork/0.14.0
